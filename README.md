...
Site          | Status
--------------|---------------------------
![Travis-CI](http://i.is.cc/storage/GYd75qN.png "Travis-CI")     | [![Build Status](https://travis-ci.org/myadmin-plugins/myadmin-opensrs-domains.svg?branch=master)](https://travis-ci.org/myadmin-plugins/myadmin-opensrs-domains)
